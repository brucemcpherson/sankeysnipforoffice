 ...
 * office doesnt have the same properties concept
 * @namespace Props
 */
var Props = (function (ns) {
  ...
  ns.isAuthDone = function () {
    // TODO this is specific to apps script so will need a polyfill to be promoted to common for the moment just return true
    return Office ? true : ScriptApp.getAuthorizationInfo(ScriptApp.AuthMode.FULL)
